...
ces2020 |>
  ...
  facet_wrap(facets = vars(employment_stat)) +
  theme_minimal() +
  labs(
    x = "Highest education",
...
\mbox{logit}(\pi_i) &= \alpha + \beta_1 \times \mbox{employment_status}_i + \beta_2 \times \mbox{education}_i + \beta_3 \times \mbox{race}_i\\
