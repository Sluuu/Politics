...
```{r}
#| label: Highest education vs number of respondents 
...
```
```{r}
#| label: Race vs number of respondents 
#| fig-cap: filtered by gender 
#| echo: false
#| eval: false
...
```
```{r}
#| label: Employment Status vs Number of respondents 
#| fig-cap: filtered by gender 
#| echo: false
#| eval: false
